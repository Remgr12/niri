...
- `map-to-focused-window`: <sup>Since: 26.5</sup> will map the tablet to the focused window's geometry, takes precedence over `map-to-focused-output` and `map-to-output`.
